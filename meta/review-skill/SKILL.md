...
4. 必要なら `reviewing-skills` の Level 2: Independent executor trial を実行する。
   ...
   - 高重要度 skill では、`reviewing-skills` の Iteration Rules に従って 3 回連続 clear、hold-out scenario、tool-use 偏り確認まで行う。
...
- Level 0: metadata / discoverability と description / body consistency の結果
- Level 1: 実施した scenario と結果
- Level 2: 実施した / 省略した理由。高重要度なら収束判定と hold-out scenario の結果
